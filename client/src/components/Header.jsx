...
export default function Header() {
    ...
    return (
        <Navbar className='border-b-2 '>
            ...
            <Button className='w-12 h-10 lg:hidden flex items-center' pill color='gray'>
                <AiOutlineSearch />
            </Button>

            <div className="flex gap-2 md:order-2">
                {/* --toggle theme btn */}
                <Button onClick={() => dispatch(changeTheme())} className='w-12 h-10 hidden sm:inline' color='gray' pill>
...

                {
                    currentUser ? (
                        ...
                        <Link to='/sign-in'>
                            <Button gradientDuoTone='purpleToBlue' outline className='font-semibold'>Sign In</Button>
                        </Link>
                    )
                }
                <Navbar.Toggle />
            ...
            <Navbar.Collapse >
                ...
                <Navbar.Link active={path === '/projects'} as={'div'} className='font-semibold'>
                    <Link to='/projects'>
                        Projects
                    </Link>
                </Navbar.Link>
